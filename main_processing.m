...
for mc = 1:num_monte_carol
    ...
    for com_rad = 1:length(com_rad_CR)
        ...
        %TODO: Calculate all matrixs in one function
        ...
        initival_values = zeros(4,10);
        % for i = 1:10
        %     initial_values(:,i) = ([1000,1000,10,10] - [network_topo.radar_pos(i,1),network_topo.radar_pos(i,2),0,0])';
        % end
        Nu = cell(1, numNodes);
        ...
        while ~converged && iteration < max_iterations
            ...
            if iteration == 1
                ...
                ange_with_error_cell = cell(1, numNodes);
                doppler_with_error_cell = cell(1, numNodes);
                numNodes_cell = cell(1, numNodes);
                radar_positions_cell = cell(1, numNodes);
                Sigma_big_1_cell = cell(1, numNodes);
